...
const SalesAisleDes = ({navigation}:any) => {
  ...
  return (
    ...
    <View style={{ flexDirection: 'column', alignItems: 'center', marginTop:'90%' }} className=' gap-2'>
      ...
      <TouchableOpacity style={{ width: '90%', backgroundColor: '#fff', padding: '4%', borderRadius: 9, borderWidth: 1, borderColor: '#005D7F' }} onPress={()=>navigation.navigate("ScanAislePhoto")}>
