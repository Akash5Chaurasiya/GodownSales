...
const SalesVerificationScan: React.FC<CamProps> = ({ navigation,route }) => {
        ...
        for (const scannedBarcode of barcodes) {
          if (scannedBarcode.rawValue && scannedBarcode.rawValue !== '') {
            ...
            if(datascan){
              ...
              dispatch(SalesQrScanSlipAsync(akaka)).then((res:any)=>{
                ...
                if(res.payload.status){
                  ...
                  navigation.navigate('SalesVImageLog',{dataState:akaka })
  ...
  return (
    ...
    hasPermission && (
      <>
        ...
        <Text style={{ color: "white", fontWeight: '600',  fontSize: 22, zIndex: 2000 }}>Scan QR Code Of Sales</Text>
        <View >
...
<Text style={{color:'white', fontSize:25, fontWeight:'800', }}>Scan QR Code Of Sales Slip</Text>
</View> */}
...
export default SalesVerificationScan
