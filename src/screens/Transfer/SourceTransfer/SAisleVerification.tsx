...
import {sourceTranferVerificationSlipAsync, sourceTransferaddImageAsync} from '../../../redux/Slice/transfer'
import { Camera, useCameraDevices } from 'react-native-vision-camera';
import Feather from 'react-native-vector-icons/Feather';
const SAisleVerification = ({navigation, route}:any) => {
...
// console.log("------------tttttttttttttttttttt", aisleID)
  ...
  const handleImageConfirmQuantity = () => {
    if (imageString ) {
      ...
      dispatch(sourceTransferaddImageAsync(dataFormat)).then((res: any) => {
...
export default SAisleVerification
