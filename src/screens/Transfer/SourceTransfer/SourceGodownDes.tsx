...
const SourceGodownDes = ({ navigation }: any) => {
          ...
          <TouchableOpacity style={{ width: '90%', margin: '6%' }}>
            ...
            <View className='flex flex-row m-2 ' style={{ justifyContent: 'space-between' }}>
              ...
              <View className='flex flex-col'>
                ...
                <Text className='text- text-base font-normal text-[#172B4D]'> {sourceG.sourceGodownQuantity.toFixed(2)}</Text>
              </View>
            </View>
            <View className='flex flex-col'>
...
<Text className='text- text-base font-normal text-[#172B4D]'> {sourceG.item.name}</Text>
      ...
      <View style={{ flexDirection: 'column', alignItems: 'center' }} className=' gap-2'>
        <TouchableOpacity style={{ width: '90%', backgroundColor: '#005D7F', padding: '4%', borderRadius: 9 }} onPress={() => navigation.navigate("STransferAisleScan", {transferId:sourceG._id, itemId: sourceG.item._id})}>
...
export default SourceGodownDes
