...
const DAisleDes = ({ navigation, route }: any) => {
      ...
      <View  >
                ...
                <View>
                  ...
                  <View style={{ flexDirection: 'column', alignItems: 'center' }} className='gap-2  mt-2' >
                    <TouchableOpacity style={{ width: '90%', backgroundColor: '#005D7F', padding: '4%', borderRadius: 9 }} onPress={() => navigation.navigate("DAislePhoto",{transferId:transferId, itemId: itemId,aisleId:aisleId })}>
                      <Text style={{ color: '#fff', fontWeight: '600', fontSize: 20, textAlign: 'center' }}>Confirm</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={{ width: '90%', backgroundColor: '#fff', padding: '4%', borderRadius: 9, borderWidth: 1, borderColor: '#005D7F' }} onPress={() => navigation.navigate("DSourceGodownDes")}>
