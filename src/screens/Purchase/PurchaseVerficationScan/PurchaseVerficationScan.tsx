...
const PurchaseVerficationScan: React.FC<CamProps> = ({ navigation,route }) => {
            ...
            if(datascan){
              ...
              dispatch(purchaseQrScanAsync(akaka)).then((res:any)=>{
                ...
                if(res.payload.status){
                  ...
                  navigation.navigate('PurchaseVImageLog', {dataState:akaka })
...
<Text style={{color:'white', fontSize:25, fontWeight:'800', }}>Scan QR Code Of Purchase Slip</Text>
</View> */}
...
export default PurchaseVerficationScan
